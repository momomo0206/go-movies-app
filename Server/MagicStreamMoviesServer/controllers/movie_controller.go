...
func GetReviewRanking(admin_review string, client *mongo.Client, c *gin.Context) (string, int, error) {
	...
	if err != nil {
		log.Println("DEBUG: GetRankings Error:", err)
		return "", 0, err
	}
	...
	if err != nil {
		log.Println("DEBUG: OpenAI Init Error:", err)
		return "", 0, err
	}
	...
	if err != nil {
		log.Println("DEBUG: OpenAI Call Error:", err)
		return "", 0, err
	}

	log.Println("DEBUG: LLM Response:", response)
