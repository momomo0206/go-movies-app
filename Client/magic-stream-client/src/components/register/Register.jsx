...
const Register = () => {
  ...
  // console.log('Value of genres:', genres);
  // console.log('Type of genres:', typeof genres);
  // console.log('Is genres an array?', Array.isArray(genres));
  ...
  return (
    <Container className='login-container d-flex align-items-center justify-content-center mon-vh-100'>
      <div
